...
testingSet.norm[,variable.names]
trainingSet.norm[,variable.names]
plot(nnModel2)
...
```{r}
error_output = data.frame("Model"= c("Decision Tree","GLM","Random Forest","SVM","Neural Net","KNN"), "Error" = c(AvgErrorDT,AvgErrorGLM,AvgErrorRF,AvgErrorSVM,NeuralNetMisClassRate,AvgError_best_knn))
print(error_output)
```
